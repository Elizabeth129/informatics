...
<html>
	...
	<div class="scroll" onclick="Scroll();" style = "position: fixed; margin-left:15px; margin-top:15px;"><button class="up" onclick="Scroll();" >
		...
		<div class="osnova">
			...
			<article>
				<div>
				<h2 style='display:none'>Главная</h2>
				<h2 style="margin-top:0;">Добро пожаловать на сайт!</h2>
				<h3>Сайт создан для учеников, которые хотят изучить информатику</h3>
				<img src="glavnaya.jpg" width="35%" style="float: left; margin: 3%;">
				<br>
				<h3 class='epigraf'>"Дорогу осилит идущий, а информатику - мыслящий"</h3>
				<h3 class='epigraf'>Гюстав Гийома</h3>
				
				<h3 class="moyo">Мой сайт предлагает базу из презентаций и тестов для 5 класса, которые помогут сделать процес обучения лёгким, разнообразным и увлекательным.</h3>
			</div>
			</article>
		</div>
		<footer>
